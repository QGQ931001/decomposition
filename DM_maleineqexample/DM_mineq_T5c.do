...
program drop _all;
*clear mata;
log using DM_mineq_T5c.log, replace;
use usmen0305_occ;
gen time=1; 
...
gen timeinv=1-time;
*do both with logit and logit as link;
...
counterfactual lwage covered ed0 ed1 ed3 ed4 ed5 ex1 ex2 ex3 ex4 ex6 ex7 ex8 ex9 
   [weight=eweight], group(time) method(logit) quantiles(0.1 0.5 0.9) noboot;
...
counterfactual lwage covered ed0 ed1 ed3 ed4 ed5 ex1 ex2 ex3 ex4 ex6 ex7 ex8 ex9 
   [weight=eweight], group(timeinv) method(logit) quantiles(0.1 0.5 0.9)  noboot;
...
counterfactual lwage covered ed0 ed1 ed3 ed4 ed5 ex1 ex2 ex3 ex4 ex6 ex7 ex8 ex9 
   [weight=eweight], group(time) method(logit) qlow(0.01) qhigh(0.99) qstep(0.01) noboot;
matrix D=e(distributions);
matrix list D;
svmat D;

counterfactual lwage covered ed0 ed1 ed3 ed4 ed5 ex1 ex2 ex3 ex4 ex6 ex7 ex8 ex9 
   [weight=eweight], group(timeinv) method(logit) qlow(0.01) qhigh(0.99) qstep(0.01) noboot;
